...
Cette référence confirme, dans le code de Jenga, que la résolution des motifs de `files` est silencieuse : un motif qui ne trouve aucun fichier correspondant ne produit ni erreur ni avertissement.

- [Builder : résolution des motifs de `files` par `glob`, sans avertissement en cas d'absence de correspondance](https://github.com/RihenUniverse/Jenga/blob/7eb93ec423199ef75a043f9249e5f0ece3dfa209/Jenga/Core/Builder.py)
