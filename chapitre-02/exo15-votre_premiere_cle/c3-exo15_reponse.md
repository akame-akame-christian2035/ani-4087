...
Cette référence confirme, dans le code de Jenga, le texte exact des invites du mode interactif et les deux comportements par défaut décrits plus haut (mot de passe `android`, fichier `keystore.jks`).

- [Commande Keygen : invites interactives et valeurs par défaut sans `-i` ni `--output`](https://github.com/RihenUniverse/Jenga/blob/7eb93ec423199ef75a043f9249e5f0ece3dfa209/Jenga/Commands/Keygen.py)
