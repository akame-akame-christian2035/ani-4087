...
Cette référence confirme, dans le code de Jenga, le comportement de `Host Environment` et la liste des chaînes recherchées par `jenga info -v`.

- [Toolchains : liste des détections effectuées par `DetectAll`, et noms exacts des chaînes (`host-clang`, `clang-mingw`, `gcc-cross-linux`, `msvc`, variables `ANDROID_NDK_ROOT`/`ANDROID_NDK_HOME`)](https://github.com/RihenUniverse/Jenga/blob/7eb93ec423199ef75a043f9249e5f0ece3dfa209/Jenga/Core/Toolchains.py)
- [Platform : `GetHostEnvironment` fixe `msvc` par défaut sous Windows, sans détection](https://github.com/RihenUniverse/Jenga/blob/7eb93ec423199ef75a043f9249e5f0ece3dfa209/Jenga/Core/Platform.py)
