...
Cette référence confirme la valeur de la chaîne `TC_WINDOWS`, citée dans le tableau ci-dessus.

- [`config/toolchain.jenga` : `TC_WINDOWS = "nk-windows-clang-mingw"`](https://github.com/Rihen-Universe/Nkentseu/blob/main/config/toolchain.jenga)
