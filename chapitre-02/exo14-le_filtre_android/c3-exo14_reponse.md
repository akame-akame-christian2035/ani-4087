...
Cette référence confirme, dans le code de Jenga, le fonctionnement de `jenga compile-flags` (son fichier de sortie `.jenga/compileflags.jcdb`, son option `--platform`) et le message d'erreur exact renvoyé quand aucune chaîne ne convient à la cible demandée.

- [Commande CompileFlags : écriture de `compileflags.jcdb` et gestion des erreurs](https://github.com/RihenUniverse/Jenga/blob/7eb93ec423199ef75a043f9249e5f0ece3dfa209/Jenga/Commands/CompileFlags.py)
- [Builder : message `No suitable toolchain found for {OS} {Arch}`](https://github.com/RihenUniverse/Jenga/blob/7eb93ec423199ef75a043f9249e5f0ece3dfa209/Jenga/Core/Builder.py)
